...
pg = st.navigation([
    st.Page(app, title="Home", icon="🏠"),
    st.Page("pages/1_Narrative.py", title="Narrative", icon="📋"),
    st.Page("pages/2_Incident_Types.py", title="Incident Types", icon="📊"),
    st.Page("pages/3_Sectoral_Vulnerability.py", title="Sectoral Vulnerability", icon="🏢"),
    st.Page("pages/4_GDPR_Compliance.py", title="GDPR Compliance", icon="⏱️"),
])
pg.run()
